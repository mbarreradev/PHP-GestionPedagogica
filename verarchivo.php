...
<div id="invoice">
    ...
    <div class="toolbar hidden-print">
        <div class="text-right">
            <button id="printInvoice" class="btn btn-info"><span class="material-icons">print</span> Imprimir</button>
            <button class="btn btn-info"><span class="material-icons">cloud_download</span> Descargar</button>
        </div>
        <hr>
    </div>
